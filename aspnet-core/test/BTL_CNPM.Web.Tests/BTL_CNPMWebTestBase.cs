...
{
    public abstract class BTL_CNPMWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static BTL_CNPMWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(BTL_CNPMWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<BTL_CNPMDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<BTL_CNPMDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<BTL_CNPMDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<BTL_CNPMDbContext, Task<T>> func)
        {
            T result;
