...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BTL_CNPM.Entity.Calendar", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("BTL_CNPM.Entity.Event", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("BTL_CNPM.Entity.Member", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("BTL_CNPM.Entity.Team", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("BTL_CNPM.Entity.TeamRole", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("BTL_CNPM.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("BTL_CNPM.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("BTL_CNPM.Entity.Calendar", b =>
                {
                    b.HasOne("BTL_CNPM.Entity.Team", "Team")
                        .WithMany()
            ...
            modelBuilder.Entity("BTL_CNPM.Entity.Event", b =>
                {
                    b.HasOne("BTL_CNPM.Entity.Calendar", "Calendar")
                        .WithMany()
            ...
            modelBuilder.Entity("BTL_CNPM.Entity.Member", b =>
                {
                    ...
                    b.HasOne("BTL_CNPM.Entity.TeamRole", "TeamRole")
                        .WithMany()
                        .HasForeignKey("TeamRoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BTL_CNPM.Authorization.Users.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
